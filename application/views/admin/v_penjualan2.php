			...
			<div class="col-lg-12">
				<center>flashdata()</center>
					<h1 class="page-header">Transaksi
						<small>Jasa (Non Member)</small>
						<a href="#" data-toggle="modal" data-target="#largeModal" class="pull-right"><small>Cari Jasa!</small></a>
					</h1>
			</div>
		</div>
		<!-- /.row -->
			...
			<div class="col-lg-12">
				...
				<table class="table table-bordered table-condensed" style="font-size:11px;margin-top:10px;">
					...
					<tbody>
						...
						<td style="text-align:center;"></td>
						<td style="text-align:center;"></td>
						<td style="text-align:center;"><a href="#" class="btn btn-warning btn-xs"><span class="fa fa-close"></span> Batal</a></td>
					</tbody>					
				</table>
				<form action="#" method="post">
					<table>
